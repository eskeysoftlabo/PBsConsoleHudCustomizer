...
function GetAddOnManager()
	return {
		...
		GetAddOnInfo = function(_, i) return "PBsConsoleHudCustomizer", "|cFF69B4PB\u{2019}s ConsoleHudCustomizer|r 1.26.0" end,
	}
end
...
function BuildAttributeBars()
	...
	-- is only the middle of that; the 17 here until 1.26.0 was the keyboard size, and it let a
