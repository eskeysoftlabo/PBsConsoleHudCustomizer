local strings = {
	...
	SI_PBSCHC_STYLE_TOOLTIP = "「標準」はゲーム本来のバーのままです。「液体」は同じバー・同じ枠のまま、中身を液体のように描きます（下側ほど暗く、光が流れ、残量の先端に液面の光の線）。ゲーム側の描画は一切隠さないため、ダメージシールドや防御力変化、瀕死の警告表示もそのまま機能します。",
	SI_PBSCHC_STYLE_STANDARD = "標準",
	SI_PBSCHC_STYLE_LIQUID = "液体",
	SI_PBSCHC_LIQUID_STRENGTH = "液体演出の強さ",
	SI_PBSCHC_LIQUID_STRENGTH_TOOLTIP = "液体演出をどれだけ強く描くかです。100%が想定の見た目で、下げると控えめに、上げるとかなり光沢が強くなります。0%は「標準」と同じです。",
